...
const DropzoneComponent: React.FC<DropzoneProps> = ({
  ...
  return (
    <div className="transition border border-gray-300 border-dashed cursor-pointer dark:hover:border-[#C0202A] dark:border-gray-700 rounded-xl hover:border-[#C0202A]">
      <div
        {...getRootProps()}
        className={`dropzone rounded-xl border-dashed border-gray-300 p-7 lg:p-10
        ${isDragActive
            ? "border-[#C0202A] bg-gray-100 dark:bg-gray-800"
      ...
      >
        ...
        <div className="dz-message flex flex-col items-center m-0!">
          ...
          <span className="font-medium underline text-theme-sm text-[#C0202A]">
            Browse File
          </span>
        </div>
      </div>
